...
extern int sec_bat_get_adc_data(struct device *dev, int adc_ch, int count);
...
extern int adjust_sub_bat_temp(struct sec_battery_info *battery, int sub_bat_temp, int bat_temp);
