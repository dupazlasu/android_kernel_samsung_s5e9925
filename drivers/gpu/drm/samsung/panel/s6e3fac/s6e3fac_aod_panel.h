...
static struct maptbl s6e3fac_aod_maptbl[] = {
	...
	[SET_PARTIAL_MODE_MAPTBL] = __OLED_MAPTBL_COPY_ONLY_INITIALIZER(s6e3fac_aod_partial_mode, &OLED_FUNC(OLED_MAPTBL_COPY_AOD_PARTIAL_MODE)),
	[SET_PARTIAL_AREA_MAPTBL] = __OLED_MAPTBL_COPY_ONLY_INITIALIZER(s6e3fac_aod_partial_area, &OLED_FUNC(OLED_MAPTBL_COPY_AOD_PARTIAL_AREA)),
	[SET_PARTIAL_HLPM_MAPTBL] = __OLED_MAPTBL_COPY_ONLY_INITIALIZER(s6e3fac_aod_partial_hlpm, &OLED_FUNC(OLED_MAPTBL_COPY_AOD_PARTIAL_HLPM)),
};
...
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e3fac_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, S6E3FAC_CRC_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static DEFINE_PKTUI(s6e3fac_aod_partial_mode, &s6e3fac_aod_maptbl[SET_PARTIAL_MODE_MAPTBL], 0);
...
static DEFINE_PKTUI(s6e3fac_aod_partial_area, &s6e3fac_aod_maptbl[SET_PARTIAL_AREA_MAPTBL], 0);
...
static DEFINE_PKTUI(s6e3fac_aod_partial_hlpm, &s6e3fac_aod_maptbl[SET_PARTIAL_HLPM_MAPTBL], 0);
