/*
 * linux/drivers/gpu/drm/samsung/panel/s6e3fac/s6e3fac_rainbow_g0.c
 *
 * s6e3fac_rainbow_g0 Driver
 *
...
extern int find_s6e3fac_vrr(struct panel_vrr *vrr);
...
__visible_for_testing int __init s6e3fac_rainbow_g0_panel_init(void)
{
	struct common_panel_info *cpi = &s6e3fac_rainbow_g0_panel_info;
...
__visible_for_testing void __exit s6e3fac_rainbow_g0_panel_exit(void)
{
	deregister_common_panel(&s6e3fac_rainbow_g0_panel_info);
}

module_init(s6e3fac_rainbow_g0_panel_init)
module_exit(s6e3fac_rainbow_g0_panel_exit)
