...
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e3fac_rainbow_g0_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, RAINBOW_G0_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static struct seqinfo s6e3fac_rainbow_g0_aod_seqtbl[] = {
	SEQINFO_INIT(SELF_MASK_IMG_SEQ, s6e3fac_rainbow_g0_aod_self_mask_img_cmdtbl),
