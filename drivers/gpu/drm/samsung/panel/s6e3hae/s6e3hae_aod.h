/*
 * linux/drivers/video/fbdev/exynos/panel/usdm/s6e3hae/s6e3hae_aod.h
 *
...
#ifndef __S6E3HAE_AOD_H__
#define __S6E3HAE_AOD_H__
...
#define SELFMASK_CHECKSUM_VALID1 0x4F
#define SELFMASK_CHECKSUM_VALID2 0xBF
...
void s6e3hae_copy_digital_blink(struct maptbl *tbl, u8 *dst);
...
//void s6e3hae_copy_self_move_enable(struct maptbl *tbl, u8 *dst);
