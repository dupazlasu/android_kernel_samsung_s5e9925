/*
 * linux/drivers/gpu/drm/samsung/panel/s6e3hae/s6e3hae_rainbow_b0_aod_panel.h
 *
...
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e3hae_rainbow_b0_aod_self_mask_img_pkt,
	DSI_PKT_TYPE_WR_SR_FAST, RAINBOW_B0_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
...
static struct seqinfo s6e3hae_rainbow_b0_aod_seqtbl[] = {
	SEQINFO_INIT(SELF_MASK_IMG_SEQ, s6e3hae_rainbow_b0_aod_self_mask_img_cmdtbl),
	SEQINFO_INIT(SELF_MASK_ENA_SEQ, s6e3hae_aod_self_mask_ena_cmdtbl),
	SEQINFO_INIT(SELF_MASK_DIS_SEQ, s6e3hae_aod_self_mask_dis_cmdtbl),
	SEQINFO_INIT(ENTER_AOD_SEQ, s6e3hae_aod_enter_aod_cmdtbl),
	SEQINFO_INIT(EXIT_AOD_SEQ, s6e3hae_aod_exit_aod_cmdtbl),
	SEQINFO_INIT(SELF_MASK_DATA_CHECK_SEQ, s6e3hae_aod_self_mask_checksum_cmdtbl),
};
...
static struct aod_tune s6e3hae_rainbow_b0_aod = {
	...
	.self_mask_en = true,
	.custom_ops = {
		.self_mask_data_check = s6e3hae_aod_self_mask_data_check,
	},
};
