...
/* ===================================================================================== */
static u8 rainbow_b0_copr_table[ARRAY_SIZE(RAINBOW_B0_COPR)];

static struct maptbl rainbow_b0_copr_maptbl[] = {
	[COPR_MAPTBL] = __OLED_MAPTBL_COPY_ONLY_INITIALIZER(rainbow_b0_copr_table, &OLED_FUNC(OLED_MAPTBL_COPY_COPR)),
};
